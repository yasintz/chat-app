...
export declare class Convert {
    ...
    static objRelUsingManualMappingToJson(value: ObjRelUsingManualMapping): string;
    ...
    static arrRelUsingManualMappingToJson(value: ArrRelUsingManualMapping): string;
    ...
    static toCustomTypeObjectRelationship(json: string): CustomTypeObjectRelationship;
    static customTypeObjectRelationshipToJson(value: CustomTypeObjectRelationship): string;
