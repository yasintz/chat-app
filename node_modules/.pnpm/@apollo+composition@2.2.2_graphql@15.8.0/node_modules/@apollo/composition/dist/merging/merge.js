...
class Merger {
    ...
    validateFieldSharing(sources, dest, mergeContext) {
        ...
        if (nonShareableSources.length > 0 && (shareableSources.length > 0 || nonShareableSources.length > 1)) {
            ...
            this.errors.push(federation_internals_1.ERRORS.INVALID_FIELD_SHARING.err(`Non-shareable field "${dest.coordinate}" is resolved from multiple subgraphs: it is resolved from ${(0, federation_internals_1.printSubgraphNames)(resolvingSubgraphs)} and defined as non-shareable in ${nonShareables}${extraHint}`, { nodes: (0, federation_internals_1.sourceASTs)(...allResolving) }));
        }
    }
