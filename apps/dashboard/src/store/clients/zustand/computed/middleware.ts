...
type ComputedMiddlewareImpl = (
  f: StateCreator<any, [], []>
) => StateCreator<any, [], []>;

const middleware: ComputedMiddlewareImpl = (f) => (set, get, api) => {
...
export default middleware as unknown as ComputedMiddleware;
